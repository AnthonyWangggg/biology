      ...
      <div id="leftbox">
        ...
        <el-form :model="formInline" class="demo-form-inline">
          ...
          <el-form-item label="显示类型">
            <el-select v-model="formInline.region" placeholder="频率">
              <el-option label="频率" value="1"></el-option>
              <el-option label="密度" value="2"></el-option>
            </el-select>
          </el-form-item>
...
<!--          <el-form-item label="分组个数">-->
<!--            <el-input v-model="formInline.num" placeholder=""></el-input>-->
<!--          </el-form-item>-->
<!--          <el-form-item label="或输入分组临界值">-->
<!--            <el-input v-model="formInline.critical" placeholder=""></el-input>-->
<!--          </el-form-item>-->
        </el-form>
...
export default {
  ...
  mounted() {
    ...
    this.formInline.no = 'Freqhistogram' + this.formInline.no
  },
  methods: {
    chartCommit(){
      let _this = this;
      ...
      if(_this.formInline.region!==''){
        _this.para.type_3 = _this.formInline.region
      }

      if(_this.formInline.Xtitle!==''){
        _this.para.X_1 = _this.formInline.Xtitle
      }

      if(_this.formInline.Ytitle!==''){
        _this.para.Y_2 = _this.formInline.Ytitle
      }

      if(_this.formInline.color!==''){
        _this.para.color_4 = _this.formInline.color
      }
      ...
      if(_this.fileData == null){
        ...
        _this.$axios({
          url: this.Host.BASE_URL + 'BaseFunction/freqhistogram/multiUpload',
          method: 'post',
          data: _this.formData,
          headers: {
          ...
          if(res.data==='token过期'){
            ...
            _this.$axios({
              url: this.Host.BASE_URL + 'BaseFunction/freqhistogram/run',
              method: 'post',
              data: _this.para,
              headers: {
