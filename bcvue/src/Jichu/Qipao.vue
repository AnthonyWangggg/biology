      ...
      <div id="leftbox">
        ...
        <el-form :model="formInline" class="demo-form-inline">
          ...
          <el-form-item label="气泡颜色">
            <el-input v-model="formInline.color1" :placeholder="formInline.color1"></el-input>
            <el-color-picker v-model="formInline.color1"></el-color-picker>
          </el-form-item>
...
export default {
  ...
  data() {
    return{
      ...
      groupNames:["seqA","seqB"], //(string)不同文件的分组名
    }
  },
  mounted() {
    this.init_chart();
